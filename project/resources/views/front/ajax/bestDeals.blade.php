...
<li class="product product-card ">
    ...
    <div class="product-outer" id="bDeals" style="height: 200px;">
        <div class="media product-inner">

            <a class="media-left" href="{{url('/',$row->slug)}}" title="Pendrive USB 3.0 Flash 64 GB">
                <img class="media-object wp-post-image img-responsive" src="{{asset($row->thumbnail)}}"  data-echo="{{asset($row->thumbnail)}}" alt="">
