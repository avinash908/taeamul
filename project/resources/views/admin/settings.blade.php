    ...
    @if ($errors->any())
          <ul class="alert alert-danger">
              @foreach($errors->all() as $error)
                  <li></li>
                <div class="col-md-12 alert alert-danger">{{ __($error) }}</div>
              @endforeach
          </ul>
      @endif
    <div class="col-md-6">
        ...
        <div class="row">
           <div class="col-md-12">
            <div class="form-group">
               ...
               <input type="email" name="email" id="current_password" class="form-control" value="{{Auth::guard('admin')->user()->email}}" required>
               @if($errors->has('email'))
